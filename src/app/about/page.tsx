...
export const metadata: Metadata = {
  title: 'About Us — Our Story, Values & Founder',
  description: 'The story behind Akiraas — why we exist, what we believe, and who we are. Built on the belief that human connection is the most powerful force in professional life.',
  alternates: { canonical: 'https://akiraas.com/about' },
  openGraph: {
    title: 'About Us — Our Story, Values & Founder',
    description: 'The story behind Akiraas — why we exist, what we believe, and who we are. Built on the belief that human connection is the most powerful force in professional life.',
    url: 'https://akiraas.com/about',
  },
};
